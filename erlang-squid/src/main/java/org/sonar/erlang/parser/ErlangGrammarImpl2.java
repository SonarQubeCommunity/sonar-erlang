...
public enum ErlangGrammarImpl2 implements GrammarRuleKey {
  ...
  private static void module(LexerlessGrammarBuilder b) {
    ...
    b.rule(recordField).is(b.sequence(b.firstOf(lcurlybrace, lbracket), recordField, b.zeroOrMore(comma,
